...
```
<!-- I commented out the following few chunks. In this notebook we should just load in the travel time matrices and all other needed data. The commented out code can be in the 'data-prep' .Rmds when they are ultimately consolidated -->
...
cum_cutoff <- cumulative_cutoff(
  travel_matrix = ttm_walk, #name of the data.frame that contains the travel times and the from_ids to to_ids
